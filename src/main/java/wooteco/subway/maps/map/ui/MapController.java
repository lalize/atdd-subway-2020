...
public class MapController {
    ...
    @GetMapping("/paths")
    public ResponseEntity<PathResponse> findPath(@AuthenticationPrincipal(guest = true) LoginMember loginMember, @RequestParam Long source, @RequestParam Long target,
